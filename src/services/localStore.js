 ...
 * localStore.js
 *
 * DEMO-ONLY fallback store. This is used ONLY when:
 *   1. The admin explicitly logs in with demo credentials (admin@vehiclerental.com / admin123)
 *   2. Supabase is not configured (missing env vars)
 *
 * It should NEVER override real Supabase data silently.
 * Real bookings/payments from the user site live in Supabase — always prefer those.
 */
  ...
  bookings: [
    {
      ...
      vehicles: { name: "Honda Dio", image_url: "https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=900&h=600&fit=crop" },
    ...
    },
    {
      ...
      customer_id: 2,
      full_name: "Mira Gurung",
      email: "mira@example.com",
      phone: "+977 9841000002",
      vehicle_id: 1,
      vehicle_name: "Hyundai Creta",
      vehicles: { name: "Hyundai Creta", image_url: "https://images.unsplash.com/photo-1549924231-f129b911e442?w=900&h=600&fit=crop" },
...
/**
 * Returns true ONLY when the admin has explicitly chosen the demo session.
 * This should NEVER return true when Supabase is configured and the admin
 * is logged in with real credentials.
 */
